...
public class ThriftAgentProcessInfo implements org.apache.thrift.TBase<ThriftAgentProcessInfo, ThriftAgentProcessInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftAgentProcessInfo> {
  ...
  private static final org.apache.thrift.protocol.TField URLS_FIELD_DESC = new org.apache.thrift.protocol.TField("URLs", org.apache.thrift.protocol.TType.LIST, (short)11);
  private static final org.apache.thrift.protocol.TField TOTAL_RECEIVED_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("totalReceivedData", org.apache.thrift.protocol.TType.DOUBLE, (short)12);
  ...
  public double totalReceivedData; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    URLS((short)11, "URLs"),
    TOTAL_RECEIVED_DATA((short)12, "totalReceivedData");
  ...
  private static final int __TOTALRECEIVEDDATA_ISSET_ID = 4;
  ...
  static {
    ...
    tmpMap.put(_Fields.URLS, new org.apache.thrift.meta_data.FieldMetaData("URLs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.TOTAL_RECEIVED_DATA, new org.apache.thrift.meta_data.FieldMetaData("totalReceivedData", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    ...
    double totalReceivedData)
  {
    ...
    setTotalReceivedDataIsSet(true);
  }
  ...
  public ThriftAgentProcessInfo(ThriftAgentProcessInfo other) {
    ...
    this.totalReceivedData = other.totalReceivedData;
  }
  ...
  public void clear() {
    ...
    this.timestamp = null;
    this.URLs = null;
    setTotalReceivedDataIsSet(false);
    this.totalReceivedData = 0.0;
  }
  ...
  public ThriftAgentProcessInfo setURLs(List<String> URLs) {
    this.URLs = URLs;
    return this;
  }
  ...
  public ThriftAgentProcessInfo setTotalReceivedData(double totalReceivedData) {
    this.totalReceivedData = totalReceivedData;
    setTotalReceivedDataIsSet(true);
    return this;
  }

  public void unsetTotalReceivedData() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TOTALRECEIVEDDATA_ISSET_ID);
  }

  /** Returns true if field totalReceivedData is set (has been assigned a value) and false otherwise */
  public boolean isSetTotalReceivedData() {
    return EncodingUtils.testBit(__isset_bitfield, __TOTALRECEIVEDDATA_ISSET_ID);
  }

  public void setTotalReceivedDataIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TOTALRECEIVEDDATA_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TOTAL_RECEIVED_DATA:
      if (value == null) {
        unsetTotalReceivedData();
      } else {
        setTotalReceivedData((Double)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case TOTAL_RECEIVED_DATA:
      return Double.valueOf(getTotalReceivedData());
  ...
  public boolean equals(ThriftAgentProcessInfo that) {
    ...
    boolean this_present_totalReceivedData = true;
    boolean that_present_totalReceivedData = true;
    if (this_present_totalReceivedData || that_present_totalReceivedData) {
      if (!(this_present_totalReceivedData && that_present_totalReceivedData))
        return false;
      if (this.totalReceivedData != that.totalReceivedData)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_totalReceivedData = true;
    list.add(present_totalReceivedData);
    if (present_totalReceivedData)
      list.add(totalReceivedData);
  ...
  public int compareTo(ThriftAgentProcessInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetTotalReceivedData()).compareTo(other.isSetTotalReceivedData());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTotalReceivedData()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.totalReceivedData, other.totalReceivedData);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("totalReceivedData:");
    sb.append(this.totalReceivedData);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class ThriftAgentProcessInfoStandardScheme extends StandardScheme<ThriftAgentProcessInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftAgentProcessInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 12: // TOTAL_RECEIVED_DATA
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.totalReceivedData = iprot.readDouble();
              struct.setTotalReceivedDataIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftAgentProcessInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(TOTAL_RECEIVED_DATA_FIELD_DESC);
      oprot.writeDouble(struct.totalReceivedData);
      oprot.writeFieldEnd();
  ...
  private static class ThriftAgentProcessInfoTupleScheme extends TupleScheme<ThriftAgentProcessInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftAgentProcessInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetTotalReceivedData()) {
        optionals.set(11);
      }
