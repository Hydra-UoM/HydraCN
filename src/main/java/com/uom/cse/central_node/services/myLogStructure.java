...
public class myLogStructure implements org.apache.thrift.TBase<myLogStructure, myLogStructure._Fields>, java.io.Serializable, Cloneable, Comparable<myLogStructure> {
  ...
  private static final org.apache.thrift.protocol.TField EVENT_CATEGORY_FIELD_DESC = new org.apache.thrift.protocol.TField("eventCategory", org.apache.thrift.protocol.TType.STRING, (short)33);
  private static final org.apache.thrift.protocol.TField PROCESS_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("processName", org.apache.thrift.protocol.TType.STRING, (short)34);
  ...
  public String eventCategory; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    MAC((short)32, "mac"),
    EVENT_CATEGORY((short)33, "eventCategory"),
    PROCESS_NAME((short)34, "processName");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 32: // MAC
          return MAC;
        case 33: // EVENT_CATEGORY
          return EVENT_CATEGORY;
        case 34: // PROCESS_NAME
          return PROCESS_NAME;
        default:
          return null;
      }
  ...
  static {
    ...
    tmpMap.put(_Fields.MAC, new org.apache.thrift.meta_data.FieldMetaData("mac", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.EVENT_CATEGORY, new org.apache.thrift.meta_data.FieldMetaData("eventCategory", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public myLogStructure setEventCategory(String eventCategory) {
    this.eventCategory = eventCategory;
    return this;
  }
  ...
  /** Returns true if field eventCategory is set (has been assigned a value) and false otherwise */
  public boolean isSetEventCategory() {
    return this.eventCategory != null;
  }

  public void setEventCategoryIsSet(boolean value) {
    if (!value) {
      this.eventCategory = null;
    }
  }
  ...
  public myLogStructure setProcessName(String processName) {
    this.processName = processName;
    return this;
  }
  ...
  public boolean equals(myLogStructure that) {
    ...
    boolean this_present_eventCategory = true && this.isSetEventCategory();
    boolean that_present_eventCategory = true && that.isSetEventCategory();
    if (this_present_eventCategory || that_present_eventCategory) {
      if (!(this_present_eventCategory && that_present_eventCategory))
        return false;
      if (!this.eventCategory.equals(that.eventCategory))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_eventCategory = true && (isSetEventCategory());
    list.add(present_eventCategory);
    if (present_eventCategory)
  ...
  public int compareTo(myLogStructure other) {
    ...
    lastComparison = Boolean.valueOf(isSetEventCategory()).compareTo(other.isSetEventCategory());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEventCategory()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.eventCategory, other.eventCategory);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class myLogStructureStandardScheme extends StandardScheme<myLogStructure> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, myLogStructure struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 33: // EVENT_CATEGORY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.eventCategory = iprot.readString();
              struct.setEventCategoryIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, myLogStructure struct) throws org.apache.thrift.TException {
      ...
      if (struct.eventCategory != null) {
        oprot.writeFieldBegin(EVENT_CATEGORY_FIELD_DESC);
        oprot.writeString(struct.eventCategory);
        oprot.writeFieldEnd();
      }
