              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.processes = new ArrayList<ThriftAgentProcessInfo>(_list8.size);
                  ThriftAgentProcessInfo _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = new ThriftAgentProcessInfo();
                    _elem9.read(iprot);
                    struct.processes.add(_elem9);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pushProcessesInfo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.processes != null) {
          oprot.writeFieldBegin(PROCESSES_FIELD_DESC);
          {
            ...
            for (ThriftAgentProcessInfo _iter11 : struct.processes)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetProcesses()) {
          {
            ...
            for (ThriftAgentProcessInfo _iter12 : struct.processes)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.processes = new ArrayList<ThriftAgentProcessInfo>(_list13.size);
            ThriftAgentProcessInfo _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = new ThriftAgentProcessInfo();
              _elem14.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.logInfo = new ArrayList<myLogStructure>(_list16.size);
                  myLogStructure _elem17;
                  for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                  {
                    _elem17 = new myLogStructure();
                    _elem17.read(iprot);
                    struct.logInfo.add(_elem17);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pushLogInfo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.logInfo != null) {
          oprot.writeFieldBegin(LOG_INFO_FIELD_DESC);
          {
            ...
            for (myLogStructure _iter19 : struct.logInfo)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetLogInfo()) {
          {
            ...
            for (myLogStructure _iter20 : struct.logInfo)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.logInfo = new ArrayList<myLogStructure>(_list21.size);
            myLogStructure _elem22;
            for (int _i23 = 0; _i23 < _list21.size; ++_i23)
            {
              _elem22 = new myLogStructure();
              _elem22.read(iprot);
              struct.logInfo.add(_elem22);
            }
          }
          struct.setLogInfoIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.usersInfo = new ArrayList<myUserAccountDetailsStruct>(_list24.size);
                  myUserAccountDetailsStruct _elem25;
                  for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                  {
                    _elem25 = new myUserAccountDetailsStruct();
                    _elem25.read(iprot);
                    struct.usersInfo.add(_elem25);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pushUsersInfo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usersInfo != null) {
          oprot.writeFieldBegin(USERS_INFO_FIELD_DESC);
          {
            ...
            for (myUserAccountDetailsStruct _iter27 : struct.usersInfo)
            {
              _iter27.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetUsersInfo()) {
          {
            ...
            for (myUserAccountDetailsStruct _iter28 : struct.usersInfo)
            {
              _iter28.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.usersInfo = new ArrayList<myUserAccountDetailsStruct>(_list29.size);
            myUserAccountDetailsStruct _elem30;
            for (int _i31 = 0; _i31 < _list29.size; ++_i31)
            {
              _elem30 = new myUserAccountDetailsStruct();
              _elem30.read(iprot);
              struct.usersInfo.add(_elem30);
            }
          }
          struct.setUsersInfoIsSet(true);
        }
    ...
    private static class pushLogInfoTest1_argsStandardScheme extends StandardScheme<pushLogInfoTest1_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.logInfo = new ArrayList<myLogStructure>(_list32.size);
                  myLogStructure _elem33;
                  for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                  {
                    _elem33 = new myLogStructure();
                    _elem33.read(iprot);
                    struct.logInfo.add(_elem33);
                  }
                  iprot.readListEnd();
                }
                struct.setLogInfoIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pushLogInfoTest1_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.logInfo != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.logInfo.size()));
            for (myLogStructure _iter35 : struct.logInfo)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class pushLogInfoTest1_argsTupleScheme extends TupleScheme<pushLogInfoTest1_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, pushLogInfoTest1_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetLogInfo()) {
          {
            oprot.writeI32(struct.logInfo.size());
            for (myLogStructure _iter36 : struct.logInfo)
            {
              _iter36.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.logInfo = new ArrayList<myLogStructure>(_list37.size);
            myLogStructure _elem38;
            for (int _i39 = 0; _i39 < _list37.size; ++_i39)
            {
              _elem38 = new myLogStructure();
              _elem38.read(iprot);
              struct.logInfo.add(_elem38);
            }
          }
          struct.setLogInfoIsSet(true);
        }
