...
public class mySubject implements org.apache.thrift.TBase<mySubject, mySubject._Fields>, java.io.Serializable, Cloneable, Comparable<mySubject> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("mySubject");
  ...
  static {
    schemes.put(StandardScheme.class, new mySubjectStandardSchemeFactory());
    schemes.put(TupleScheme.class, new mySubjectTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(mySubject.class, metaDataMap);
  }
   ...
   */
  public mySubject(mySubject other) {
  ...
  public mySubject deepCopy() {
    return new mySubject(this);
  }
  ...
  public mySubject setSecurity_ID(String Security_ID) {
    this.Security_ID = Security_ID;
    return this;
  }
  ...
  public mySubject setAccount_Name(String Account_Name) {
    this.Account_Name = Account_Name;
    return this;
  }
  ...
  public mySubject setAccount_Domain(String Account_Domain) {
    this.Account_Domain = Account_Domain;
    return this;
  }
  ...
  public mySubject setLogon_ID(String Logon_ID) {
    this.Logon_ID = Logon_ID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof mySubject)
      return this.equals((mySubject)that);
    return false;
  }

  public boolean equals(mySubject that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(mySubject other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("mySubject(");
    boolean first = true;
  ...
  private static class mySubjectStandardSchemeFactory implements SchemeFactory {
    public mySubjectStandardScheme getScheme() {
      return new mySubjectStandardScheme();
    }
  }

  private static class mySubjectStandardScheme extends StandardScheme<mySubject> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, mySubject struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, mySubject struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class mySubjectTupleSchemeFactory implements SchemeFactory {
    public mySubjectTupleScheme getScheme() {
      return new mySubjectTupleScheme();
    }
  }

  private static class mySubjectTupleScheme extends TupleScheme<mySubject> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, mySubject struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, mySubject struct) throws org.apache.thrift.TException {
