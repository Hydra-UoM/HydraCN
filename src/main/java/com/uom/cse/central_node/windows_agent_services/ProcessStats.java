...
public class ProcessStats {
  ...
  public interface Iface {
    ...
    public void getLogRelatedInformation(long timeGapInMilliSeconds, long summarizationLevel, List<String> eventIndices, String logType, String process_name, String securityLevel) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getLogRelatedInformation(long timeGapInMilliSeconds, long summarizationLevel, List<String> eventIndices, String logType, String process_name, String securityLevel, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void getLogRelatedInformation(long timeGapInMilliSeconds, long summarizationLevel, List<String> eventIndices, String logType, String process_name, String securityLevel) throws org.apache.thrift.TException
    {
      send_getLogRelatedInformation(timeGapInMilliSeconds, summarizationLevel, eventIndices, logType, process_name, securityLevel);
      recv_getLogRelatedInformation();
    }

    public void send_getLogRelatedInformation(long timeGapInMilliSeconds, long summarizationLevel, List<String> eventIndices, String logType, String process_name, String securityLevel) throws org.apache.thrift.TException
    {
      getLogRelatedInformation_args args = new getLogRelatedInformation_args();
      args.setTimeGapInMilliSeconds(timeGapInMilliSeconds);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getLogRelatedInformation<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getLogRelatedInformation_args> {
      ...
      public getLogRelatedInformation_result getResult(I iface, getLogRelatedInformation_args args) throws org.apache.thrift.TException {
        getLogRelatedInformation_result result = new getLogRelatedInformation_result();
        iface.getLogRelatedInformation(args.timeGapInMilliSeconds, args.summarizationLevel, args.eventIndices, args.logType, args.process_name, args.securityLevel);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getLogRelatedInformation<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getLogRelatedInformation_args, Void> {
      ...
      public void start(I iface, getLogRelatedInformation_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.getLogRelatedInformation(args.timeGapInMilliSeconds, args.summarizationLevel, args.eventIndices, args.logType, args.process_name, args.securityLevel,resultHandler);
      }
    }
...
;
  ...
  public static class getLogRelatedInformation_args implements org.apache.thrift.TBase<getLogRelatedInformation_args, getLogRelatedInformation_args._Fields>, java.io.Serializable, Cloneable, Comparable<getLogRelatedInformation_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TIME_GAP_IN_MILLI_SECONDS_FIELD_DESC = new org.apache.thrift.protocol.TField("timeGapInMilliSeconds", org.apache.thrift.protocol.TType.I64, (short)1);
    private static final org.apache.thrift.protocol.TField SUMMARIZATION_LEVEL_FIELD_DESC = new org.apache.thrift.protocol.TField("summarizationLevel", org.apache.thrift.protocol.TType.I64, (short)2);
    ...
    public long timeGapInMilliSeconds; // required
    public long summarizationLevel; // required
    ...
    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      TIME_GAP_IN_MILLI_SECONDS((short)1, "timeGapInMilliSeconds"),
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // TIME_GAP_IN_MILLI_SECONDS
            return TIME_GAP_IN_MILLI_SECONDS;
    ...
    // isset id assignments
    private static final int __TIMEGAPINMILLISECONDS_ISSET_ID = 0;
    private static final int __SUMMARIZATIONLEVEL_ISSET_ID = 1;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.TIME_GAP_IN_MILLI_SECONDS, new org.apache.thrift.meta_data.FieldMetaData("timeGapInMilliSeconds", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    public getLogRelatedInformation_args(
      long timeGapInMilliSeconds,
      long summarizationLevel,
      ...
      String securityLevel)
    {
      this();
      this.timeGapInMilliSeconds = timeGapInMilliSeconds;
      setTimeGapInMilliSecondsIsSet(true);
      this.summarizationLevel = summarizationLevel;
    ...
    public getLogRelatedInformation_args(getLogRelatedInformation_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.timeGapInMilliSeconds = other.timeGapInMilliSeconds;
    ...
    @Override
    public void clear() {
      setTimeGapInMilliSecondsIsSet(false);
      this.timeGapInMilliSeconds = 0;
    ...
    public long getTimeGapInMilliSeconds() {
      return this.timeGapInMilliSeconds;
    }

    public getLogRelatedInformation_args setTimeGapInMilliSeconds(long timeGapInMilliSeconds) {
      this.timeGapInMilliSeconds = timeGapInMilliSeconds;
      setTimeGapInMilliSecondsIsSet(true);
      return this;
    }

    public void unsetTimeGapInMilliSeconds() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TIMEGAPINMILLISECONDS_ISSET_ID);
    }

    /** Returns true if field timeGapInMilliSeconds is set (has been assigned a value) and false otherwise */
    public boolean isSetTimeGapInMilliSeconds() {
      return EncodingUtils.testBit(__isset_bitfield, __TIMEGAPINMILLISECONDS_ISSET_ID);
    }

    public void setTimeGapInMilliSecondsIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TIMEGAPINMILLISECONDS_ISSET_ID, value);
    }

    public long getSummarizationLevel() {
      return this.summarizationLevel;
    }

    public getLogRelatedInformation_args setSummarizationLevel(long summarizationLevel) {
      this.summarizationLevel = summarizationLevel;
      setSummarizationLevelIsSet(true);
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case TIME_GAP_IN_MILLI_SECONDS:
        if (value == null) {
          unsetTimeGapInMilliSeconds();
        } else {
          setTimeGapInMilliSeconds((Long)value);
        }
        break;
      ...
      case SUMMARIZATION_LEVEL:
        if (value == null) {
          ...
          setSummarizationLevel((Long)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case TIME_GAP_IN_MILLI_SECONDS:
        return Long.valueOf(getTimeGapInMilliSeconds());

      case SUMMARIZATION_LEVEL:
        return Long.valueOf(getSummarizationLevel());
    ...
    public boolean isSet(_Fields field) {
      ...
      switch (field) {
      case TIME_GAP_IN_MILLI_SECONDS:
        return isSetTimeGapInMilliSeconds();
      case SUMMARIZATION_LEVEL:
    ...
    public boolean equals(getLogRelatedInformation_args that) {
      ...
      boolean this_present_timeGapInMilliSeconds = true;
      boolean that_present_timeGapInMilliSeconds = true;
      if (this_present_timeGapInMilliSeconds || that_present_timeGapInMilliSeconds) {
        if (!(this_present_timeGapInMilliSeconds && that_present_timeGapInMilliSeconds))
          return false;
        if (this.timeGapInMilliSeconds != that.timeGapInMilliSeconds)
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_timeGapInMilliSeconds = true;
      list.add(present_timeGapInMilliSeconds);
      if (present_timeGapInMilliSeconds)
        list.add(timeGapInMilliSeconds);
    ...
    public int compareTo(getLogRelatedInformation_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetTimeGapInMilliSeconds()).compareTo(other.isSetTimeGapInMilliSeconds());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetTimeGapInMilliSeconds()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.timeGapInMilliSeconds, other.timeGapInMilliSeconds);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("timeGapInMilliSeconds:");
      sb.append(this.timeGapInMilliSeconds);
      first = false;
      if (!first) sb.append(", ");
    ...
    private static class getLogRelatedInformation_argsStandardScheme extends StandardScheme<getLogRelatedInformation_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getLogRelatedInformation_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // TIME_GAP_IN_MILLI_SECONDS
              if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
                struct.timeGapInMilliSeconds = iprot.readI64();
                struct.setTimeGapInMilliSecondsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
            case 2: // SUMMARIZATION_LEVEL
              if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
                struct.summarizationLevel = iprot.readI64();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLogRelatedInformation_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        oprot.writeFieldBegin(TIME_GAP_IN_MILLI_SECONDS_FIELD_DESC);
        oprot.writeI64(struct.timeGapInMilliSeconds);
        oprot.writeFieldEnd();
        oprot.writeFieldBegin(SUMMARIZATION_LEVEL_FIELD_DESC);
        oprot.writeI64(struct.summarizationLevel);
        oprot.writeFieldEnd();
    ...
    private static class getLogRelatedInformation_argsTupleScheme extends TupleScheme<getLogRelatedInformation_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getLogRelatedInformation_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetTimeGapInMilliSeconds()) {
          optionals.set(0);
        }
